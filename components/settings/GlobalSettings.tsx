                              ...
                              <div className="space-y-1.5">
                                ...
                                <div className="flex items-center gap-2">
                                  <input
                                    ...
                                    className="flex-1 px-3 py-1.5 border border-gray-200/50 rounded-lg bg-transparent hover:bg-gray-50 text-gray-700 text-xs transition-colors focus:outline-none focus:ring-1 focus:ring-blue-500/50"
                                  />
                                  <button
                                    onClick={() => toggleApiKeyVisibility(cli.id)}
                                    className="p-1.5 text-gray-400 hover:text-gray-600 transition-colors"
                                  >
                                    {apiKeyVisibility[cli.id] ? (
                                      <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <p className="text-[10px] text-gray-500">
                                  Stored locally and injected as GEMINI_API_KEY when running Gemini.
                                </p>
                              </div>
                            )}
